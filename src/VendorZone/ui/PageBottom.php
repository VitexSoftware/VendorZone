...
class PageBottom extends \Ease\Html\FooterTag
{
    ...
    public function __construct($content = null)
    {
        ...
        $listF1->addItemSmart(new \Ease\Html\ATag('https://github.com/VitexSoftware/VendorZone/',
            _('Source code')));
        $listF1->addItemSmart(new \Ease\Html\ATag('https://github.com/VitexSoftware/VendorZone/issues',
            _('Issues')));
